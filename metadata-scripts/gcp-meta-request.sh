...
list=( $(curl -s 'http://169.254.169.254/computeMetadata/v1/instance/' -H 'Metadata-Flavor: Google') )
...
custom=`curl -s 'http://169.254.169.254/computeMetadata/v1/instance/'"$input" -H 'Metadata-Flavor: Google'`
echo -e "\nThe result is: \n$custom\n"
